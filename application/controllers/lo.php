...
Class Lo extends CI_Controller
{
	...
	function buscar_lo($params, $sess, $user)
	{
	...
	function load_metadata($id_lo, $id_rep)
	{
	...
	protected
	function recomendacion($oas, $user)
	{
		$parametros = array(
	...
	function llenar_recomendacion($return1)
	{
	...
	function load_indicadores($id_lo, $id_rep, $username)
	{
