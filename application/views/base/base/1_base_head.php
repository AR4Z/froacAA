...
<?php if($view == 'base/login/login_view') : ?>
  ...
  <li class="nav-item">
    <a class="nav-link active" id="interfaz-tab" data-toggle="tab" href="#interfaz" role="tab" aria-controls="interfaz" aria-selected="true">Interfaz</a>
  </li>
  <li class="nav-item">
...
<div class="tab-content" id="myTabContent">
    <br>
  <div class="tab-pane fade show active" id="interfaz" role="tabpanel" aria-labelledby="interfaz-tab">
      <div class="d-flex flex-row flex-nowrap">
          <div class="card bg-light mb-3" style="max-width: 18rem;">
              <div class="card-header text-center"><span><b>TAMAÑO DE FUENTE</b></span></div>
              <div class="card-body">
  ...
  <div class="tab-pane fade" id="narrator" role="tabpanel" aria-labelledby="narrator-tab">...</div>
  <div class="tab-pane fade" id="screen-reader" role="tabpanel" aria-labelledby="screen-reader-tab">...</div>
</div>
                <br/>
                <!--<div class="d-flex flex-row flex-nowrap">
                    <div class="card bg-light mb-3" style="max-width: 18rem;">
