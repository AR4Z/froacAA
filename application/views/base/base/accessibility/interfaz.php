          ...
          <div id="card-interline-size" class="card bg-light mb-3" style="max-width: 18rem;">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col">
                  <div class="input-group">
                    <input type="number" id="interlineSpaceSizeInput" name="interlineSpaceSize" value="1.5" min="1" max="2"
                      step="0.1">
                  </div>
                </div>
              </div>
            ...
            <div class="card-body">
              <fieldset role="radiogroup" aria-labelledby="group_contrast">
                ...
                <div class="row">
                  <div class="col">
                    <div class="">
                      <input class="form-check-input contrast-input sr-only" type="radio" name="radioOptionscontrast"
                        id="normalContrast" value="1" aria-label="<?php echo $this->lang->line('normal'); ?>">
                  ...
                  <div class="col">
                    <div class="">
                      <input class="form-check-input contrast-input sr-only" type="radio" name="radioOptionscontrast"
                        id="inlineRadio2" value="2" aria-label="<?php echo $this->lang->line('black_white'); ?>">
                      <label class="form-check-label contrast-label" for="inlineRadio2" data-toggle="tooltip"
                        ...
                        <img alt="<?php echo $this->lang->line('black_white'); ?>" style="height: 40px; width: 40px;"
                  ...
                  <div class="col">
                    <div class="">
                      <input class="form-check-input contrast-input sr-only" type="radio" name="radioOptionscontrast"
                        id="inlineRadio3" value="3" aria-label="<?php echo $this->lang->line('white_black'); ?>">
                      <label class="form-check-label contrast-label" for="inlineRadio3" data-toggle="tooltip"
                        ...
                        <img alt="<?php echo $this->lang->line('white_black'); ?>" style="height: 40px; width: 40px;"
                  ...
                  <div class="col">
                    <div class="">
                      <input class="form-check-input contrast-input sr-only" type="radio" name="radioOptionscontrast"
                        id="inlineRadio4" value="4" aria-label="<?php echo $this->lang->line('black_yellow'); ?>">
                  ...
                  <div class="col">
                    <div class="">
                      <input class="form-check-input contrast-input sr-only" type="radio" name="radioOptionscontrast"
                        id="inlineRadio5" value="5" aria-label="<?php echo $this->lang->line('yellow_black'); ?>">
                  ...
                  <div class="col">
                    <div class="">
                      <input class="form-check-input contrast-input sr-only" type="radio" name="radioOptionscontrast"
                        id="inlineRadio6" value="6" aria-label="<?php echo $this->lang->line('gray'); ?>">
                  ...
                  <div class="col">
                    <div class="">
                      <input class="form-check-input contrast-input sr-only" type="radio" name="radioOptionscontrast"
                        id="inlineRadio7" value="7" aria-label="<?php echo $this->lang->line('customized'); ?>">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <div id="div-color-background" class="no-high-contrast" style="display:none">
                      ...
                      <br />
                      <div class="input-group colorpicker-component formcolorpicker no-high-contrast no-invert-color">
                        <input type="text" id="backgroundColorInput" name="backgroundColor" value="rgb(255, 255, 255)"
                          class="jscolor form-control no-high-contrast no-invert-color" />
                      </div>
                    </div>
                  ...
                  <div class="col">
                    <div id="div-color-highlight" class="no-high-contrast" style="display:none">
                      ...
                      <br />
                      <div class="input-group colorpicker-component formcolorpicker no-high-contrast no-invert-color">
                        <input type="text" id="highlightColorInput" name="highlightColor" value="rgb(211, 211, 211)"
                          class="jscolor form-control no-high-contrast no-invert-color" />
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col">
                    <div class="row">
                      <div class="col">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" role="radio" name="type-font" id="defaultFont"
                            value="1">
                    ...
                    <div class="row">
                      <div class="col">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" role="radio" name="type-font" id="serifFont"
                            value="2">
                    ...
                    <div class="row">
                      <div class="col">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" role="radio" name="type-font" id="cantarellFont"
                            value="3">
                    ...
                    <div class="row">
                      <div class="col">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" role="radio" name="type-font" id="sourceCodePROFont"
                            value="4">
        ...
        <div class="d-flex flex-row flex-nowrap">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <fieldset class="col" role="radiogroup" aria-labelledby="group_size_cursor">
                  ...
                  <br />
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" role="radio" name="radioOptionsSizeCursor" id="normalSizeCursor"
                      value="1">
                    <label class="form-check-label" for="normalSizeCursor">
                      <?php echo $this->lang->line('no_change'); ?></label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" role="radio" name="radioOptionsSizeCursor" id="cursorSize16"
                      value="2">
                    <label class="form-check-label" for="cursorSize16">16 x 16</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" role="radio" name="radioOptionsSizeCursor" id="cursorSize32"
                      value="3">
                    <label class="form-check-label" for="cursorSize32">32 x 32</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" role="radio" name="radioOptionsSizeCursor" id="cursorSize40"
                      value="4">
                ...
                <fieldset class="col" role="radiogroup" aria-labelledby="group_trail_cursor">
                  ...
                  <br />
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="radioOptionsSizeCursorTrails" id="normalSizeCursorTrails"
                      value="1" checked>
                    <label class="form-check-label" for="normalSizeCursorTrails">
                      <?php echo $this->lang->line('without_trail'); ?></label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="radioOptionsSizeCursorTrails" id="cursorSizeTrails12"
                      value="2">
                    <label class="form-check-label" for="cursorSizeTrails12">12</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="radioOptionsSizeCursorTrails" id="cursorSizeTrails24"
                      value="3">
          ...
          <div id="card-config-colors" class="card bg-light mb-3" style="max-width: 18rem; min-width: 18rem;">
            <div class="card-header text-center">
              <span>
                <b>
                  <?php echo $this->lang->line('cfg_colors'); ?>
                </b>
              </span>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <p>
                    <?php echo $this->lang->line('message_cfG_colors'); ?>
                  </p>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <fieldset role="group" aria-labelledby="group_invert_colors">
                    <legend id="group_invert_colors" style="font-size:1rem;font-weight:bold;">
                    <?php echo $this->lang->line('invert_color'); ?>
                    </legend>
                    <div class="form-group">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" id="invertImagesCheck" name="invertImages">
                      <label class="form-check-label" for="invertImagesCheck" style="margin-left:5px;">
                  ...
                  <div class="form-group">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" id="invertGeneralCheck" name="invertGeneral">
                      <label class="form-check-label" for="invertGeneralCheck" style="margin-left:5px;">
