                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="speedBajo">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="speedMedio">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="speedAlto">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="pitchBajo">
                          <?php echo $this->lang->line('low'); ?></label>
                      </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="pitchMedio">
                          <?php echo $this->lang->line('medium'); ?></label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="pitchAlto">
                          <?php echo $this->lang->line('high'); ?></label>
                      </div>
          ...
          <div id="card-narrator-volume" class="card bg-light mb-3" style="max-width: 18rem;">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <p>
                    <?php echo $this->lang->line('message_volume'); ?>.</p>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="volumeBajo">
                          <?php echo $this->lang->line('low'); ?></label>
                      </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="volumeMedio">
                          <?php echo $this->lang->line('medium'); ?></label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="volumeAlto">
                          <?php echo $this->lang->line('high'); ?></label>
                      </div>
          ...
          <div id="card-narrator-voice-gender" class="card bg-light mb-3" style="max-width: 18rem;">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <p>
                    <?php echo $this->lang->line('message_gender_voice'); ?>.</p>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender-narrator" id="genderFemaleNarrator"
                          value="1">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender-narrator" id="genderMasculineNarrator"
                          value="2">
          ...
          <div id="card-narrator-link" class="card bg-light mb-3" style="max-width: 18rem;">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <p>
                    <?php echo $this->lang->line('message_links'); ?>.</p>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="link-narrator" id="speak-link-narrator"
                          value="1">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="link-narrator" id="different-voice-link-narrator"
                          value="2">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="link-narrator" id="sound-effect-link-narrator"
                          value="3">
          ...
          <div id="card-narrator-highlight" class="card bg-light mb-3" style="max-width: 18rem;">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <p>
                    <?php echo $this->lang->line('message_highlight'); ?>.</p>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="highlight-narrator" id="word-highlight-narrator"
                          value="1">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="highlight-narrator" id="line-highlight-narrator"
                          value="2">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="highlight-narrator" id="sentence-highlight-narrator"
                          value="3">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="highlight-narrator" id="paragraph-highlight-narrator"
                          value="4">
          ...
          <div id="card-narrator-read-mode" class="card bg-light mb-3" style="max-width: 18rem;">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <p>
                    <?php echo $this->lang->line('message_read_mode'); ?>.</p>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="reading-unit-narrator" id="ru-word-narrator"
                          value="1">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="reading-unit-narrator" id="ru-line-narrator"
                          value="2">
              ...
              <div class="row">
                <div class="col">
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="reading-unit-narrator" id="ru-sentence-narrator"
                          value="3">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="reading-unit-narrator" id="ru-paragraph-narrator"
                          value="4">
