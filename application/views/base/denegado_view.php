...
<div class="container" role="main">
    <form class="form-signin" action="<?php echo base_url()?>index.php/sesion" method="POST">
        <h2 class="form-signin-heading">Federación de Repositorios de Objetos de Aprendizaje Colombia <br><br>
            <img src="<?php echo base_url() ?>asset/img/logo2.png" alt="aca pondre el texto :D" width="50"></h2>
        <div class="login-wrap">

            <div class="registration" align="center">
                No tiene permisos suficientes para ingresar a esa área<br>
            </div>
           <br>
            <div class="registration" align="center">
