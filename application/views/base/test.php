...
Recibidos
	x
Orlando Hernandez Nunez <ohernandezn@unal.edu.co>

16 jul. (hace 6 días)

para Luis
Buenos dias Luis, me puede hacer el favor de enviarme los cambios que le hizo a FROAC donde agrega los nuevos campos que aparecen en el formulario de registro. Gracias!

Luis Felipe Londono Rojas

Archivos adjuntos16 jul. (hace 6 días)

para mí
Los cambios se hicieron en el modelo y controlador de usuario y la vista registro_view dentro de la carpeta register en las vistas.
3 archivos adjuntos
Luis Felipe Londono Rojas
...
para mí
si le parece Orlando para no tener que enviarle mis cambios y demas, le comparto el proyecto de froac por github para que cuando haya cambios usted los descargue, o le doy mi conexión al servidor para que descargue lo que necesite de los proyectos, usted me dira cual de las dos opciones le parece mejor.
Orlando Hernandez Nunez <ohernandezn@unal.edu.co>

16 jul. (hace 6 días)

para Luis
puede ser por Github, mi usuario es ar4z y estoy registrado con este correo.
