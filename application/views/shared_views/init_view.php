               ...
               <div class="panel-body">
                  <div class="">
                     <div class="text-center">
                        <h1 class="froac" style="font-size:2rem;" title="Federación de Repositorios de Objetos de Aprendizaje Colombia">Federación de Repositorios de Objetos de Aprendizaje Colombia
