                                ...
                                <div class="card border-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="cont_fecha_nac" class="form-group">
                                            ...
                                            <input type="text" class="birthdate form-control" value="<?php echo $usr_all_data[0]['use_datebirth'] ?>" id="input_fecha_nac" name="fecha_nac" placeholder="<?php echo $this->lang->line('birthdate'); ?>" aria-labelledby="fecha_nac" aria-required="true"></input>
                                        </div>
                                        ...
                                        <div class="form-group" role="group" aria-labelledby="label_use_voice_recognition">
                                            <label for="useVoiceRecognition" id="label_use_voice_recognition"><?php echo $this->lang->line('use_voice_recognition'); ?></label>
                                            <select id="useVoiceRecognition" class="form-control input-sm m-bot15" name="useVoiceRecognition" aria-labelledby="label_use_voice_recognition" role="listbox" aria-required="true">
                                                <?php
                                                foreach ($optsAdapta as $key) { ?>
                                                    <?php if ($key->option_use_id == 3) : ?>
                                                        <option value="<?php echo $key->option_use_id ?>" selected><?php echo $key->option_use ?></option>
