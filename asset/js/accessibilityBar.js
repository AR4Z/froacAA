      ...
      return new Promise((resolve, reject) => {
        resolve({
          data_custom_interfaz: {
            ...
            word_spacing: parseFloat(localStorage.getItem('word_spacing')) || 1.92,
            ...
            limit_chars_per_line: localStorage.getItem('limit_chars_per_line') || 'true',
            disable_cursor: localStorage.getItem('disable_cursor') || 'false',
