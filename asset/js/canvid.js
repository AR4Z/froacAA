        ...
        if (hasCanvas()) {
            ...
            loadImages(_opts.videos, function (err, images) {
                ...
                control.play = function (key, reverse, fps) {
                    ...
                    var img = images[key];
                    var opts = _opts.videos[key];
                    // custom modification to get the frames of an image
                    opts.frames = img.height / _opts.height;
                    var frameWidth = img.width / opts.cols;
                    var frameHeight = img.height / Math.ceil(opts.frames / opts.cols);
